...
<!-- TODO: ask about where to see the line coverage -->
The percentage of test coverage represented by the tests in _assignments #3 and #2_ is **only 14%** in _branch coverage_ and **?%** in _line coverage_ , when not considering the _gui_ classes.
