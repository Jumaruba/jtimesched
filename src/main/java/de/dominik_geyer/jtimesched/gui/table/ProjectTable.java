...
public class ProjectTable extends JTable {
  ...
  public ProjectTable(JFrame parentFrame, ProjectTableModel ptm) {
    ...
    // this.tblSched.putClientProperty("terminateEditOnFocusLost",
    ...
    // CustomCellRenderer(/*defaultRenderer*/));
    ...
    for (Object[] cp : columnProps) {
      ...
      if ((Integer) cp[1] > 0) tc.setPreferredWidth((Integer) cp[1]);

      if ((Integer) cp[2] > 0) tc.setMinWidth((Integer) cp[2]);
